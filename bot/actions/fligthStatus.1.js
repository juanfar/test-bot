...
module.exports = [
    ...
    (session, args) => {
        ...
        console.log('sDAte', session.conversationData.sDate);
        ...
        console.log('sNumber', session.conversationData.sNumber);
        ...
        /* console.log('from ->', session.dialogData.sFrom[0].resolution.values[0]);
        console.log('To ->', session.dialogData.sTo[1].resolution.values[0]); */

        /* console.log('DATE ->', session.conversationData.sDate);
        console.log('NUMBER ->', session.conversationData.sNumber); */
       ...
       try {
        ...
        validar = function () {
                ...
                if(session.conversationData.sDate && session.conversationData.sNumber) {
                ...
                if(session.conversationData.sDate && session.conversationData.origen && session.conversationData.destino) {
                    console.log('flujo DATE/FROMandTO');
                    session.conversationData.pendiente = 'fechaForRoute';
                    ...
                    if (session.conversationData.origen) {
